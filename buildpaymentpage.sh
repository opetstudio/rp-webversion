...
sed 's/__LANG__/${__LANG__}/g;s/__SERVER_DATA__/${__SERVER_DATA__}/g' build/index.html > build/index_replaced.html 
cp -rf build/index_replaced.html ~/workspace_java/$PROJECT_JSP/src/main/webapp/WEB-INF/jsp/spa.jsp 
